...
const FALLBACK: HomeContent = {
  ...
  heroText:
    'Venda consultiva, dimensionamento técnico e soluções híbridas com bateria de lítio para casas e empresas que querem economia, autonomia e previsibilidade.',
  ...
  solutions: [
    {
      title: 'Residencial',
      text: 'Reduza a conta de luz e prepare sua casa para carregar, armazenar e consumir melhor.',
    },
    {
      title: 'Comercial',
      text: 'Transforme energia em previsibilidade financeira para lojas, clínicas, escritórios e galpões.',
    },
    {
      title: 'Industrial',
      text: 'Projetos de maior porte com análise de demanda, retorno e continuidade operacional.',
    },
    {
      title: 'Agronegócio',
      text: 'Geração distribuída para bombas, refrigeração, irrigação e rotinas intensivas de consumo.',
    },
  ],
  processSteps: [
    {
      title: 'Diagnóstico',
      text: 'Analisamos sua conta de luz, rotina de consumo, telhado e objetivo de economia.',
    },
    {
      title: 'Dimensionamento',
      text: 'Dimensionamos módulos, inversor, retorno estimado e, quando fizer sentido, bateria de lítio.',
    },
    {
      title: 'Proposta clara',
      text: 'Apresentamos investimento, payback, equipamentos e próximos passos com clareza.',
    },
    {
      title: 'Instalação',
      text: 'Cuidamos da implantação e orientamos o acompanhamento da geração depois da entrega.',
    },
  ],
  projects: [
    {
      title: 'Instalação solar 1',
      category: 'Instalação solar',
      power: 'Projeto fotovoltaico',
      imageUrl: 'assets/projects/1000093004.jpg',
      alt: 'Instalação de energia solar',
    },
    {
      title: 'Instalação solar 2',
      category: 'Instalação solar',
      power: 'Projeto fotovoltaico',
      imageUrl: 'assets/projects/1000093007.jpg',
      alt: 'Instalação de energia solar',
    },
    {
      title: 'Instalação solar 3',
      category: 'Instalação solar',
      power: 'Projeto fotovoltaico',
      imageUrl: 'assets/projects/1000141815.jpg',
      alt: 'Instalação de energia solar',
    },
    {
      title: 'Instalação solar 4',
      category: 'Instalação solar',
      power: 'Projeto fotovoltaico',
      imageUrl: 'assets/projects/dayse-8kw-1000kwh-mes.jpeg',
      alt: 'Instalação de energia solar',
    },
    {
      title: 'Instalação solar 5',
      category: 'Instalação solar',
      power: 'Projeto fotovoltaico',
      imageUrl: 'assets/projects/img-20190603-101900150.jpg',
      alt: 'Instalação de energia solar',
    },
    {
      title: 'Instalação solar 6',
      category: 'Instalação solar',
      power: 'Projeto fotovoltaico',
      imageUrl: 'assets/projects/instalacao-placas-joao-03.jpg',
      alt: 'Instalação de placas solares',
    },
    {
      title: 'Instalação solar 7',
      category: 'Instalação solar',
      power: 'Projeto fotovoltaico',
      imageUrl: 'assets/projects/inversor-instalado-joao-6-5kw.jpg',
      alt: 'Inversor solar instalado',
    },
    {
      title: 'Instalação solar 8',
      category: 'Instalação solar',
      power: 'Projeto fotovoltaico',
      imageUrl: 'assets/projects/jorge-01-7kw.jpg',
      alt: 'Instalação de energia solar',
    },
    {
      title: 'Instalação solar 9',
      category: 'Instalação solar',
      power: 'Projeto fotovoltaico',
      imageUrl: 'assets/projects/jorge-02.jpg',
      alt: 'Instalação de energia solar',
    },
    {
      title: 'Instalação solar 10',
      category: 'Instalação solar',
      power: 'Projeto fotovoltaico',
      imageUrl: 'assets/projects/lenilson-gd-02.jpg',
      alt: 'Instalação de energia solar',
    },
    {
      title: 'Instalação solar 11',
      category: 'Instalação solar',
      power: 'Projeto fotovoltaico',
      imageUrl: 'assets/projects/ricardo-01-5-5kw.jpg',
      alt: 'Instalação de energia solar',
    },
    {
      title: 'Instalação solar 12',
      category: 'Instalação solar',
      power: 'Projeto fotovoltaico',
      imageUrl: 'assets/projects/ricardo-02.jpg',
      alt: 'Instalação de energia solar',
    },
    {
      title: 'Instalação solar 13',
      category: 'Instalação solar',
      power: 'Projeto fotovoltaico',
      imageUrl: 'assets/projects/sinclar-01-8kw.jpg',
      alt: 'Instalação de energia solar',
    },
    {
      title: 'Instalação solar 14',
      category: 'Instalação solar',
      power: 'Projeto fotovoltaico',
      imageUrl: 'assets/projects/sinclar-03.jpg',
      alt: 'Instalação de energia solar',
    },
    {
      title: 'Instalação solar 15',
      category: 'Instalação solar',
      power: 'Projeto fotovoltaico',
      imageUrl: 'assets/projects/sinclar-06.jpg',
      alt: 'Instalação de energia solar',
    },
    {
      title: 'Instalação solar 16',
      category: 'Instalação solar',
      power: 'Projeto fotovoltaico',
      imageUrl: 'assets/projects/telhado-01.jpg',
      alt: 'Sistema solar instalado em telhado',
    },
    {
      title: 'Instalação solar 17',
      category: 'Instalação solar',
      power: 'Projeto fotovoltaico',
      imageUrl: 'assets/projects/telhado-02.jpg',
      alt: 'Sistema solar instalado em telhado',
    },
    {
      title: 'Instalação solar 18',
      category: 'Instalação solar',
      power: 'Projeto fotovoltaico',
      imageUrl: 'assets/projects/modulos-natalia-02.jpg',
      alt: 'Módulos de energia solar instalados',
    },
    {
      title: 'Instalação solar 19',
      category: 'Instalação solar',
      power: 'Projeto fotovoltaico',
      imageUrl: 'assets/projects/modulos-natalia-03.jpg',
      alt: 'Módulos de energia solar instalados',
    },
    {
      title: 'Instalação solar 20',
      category: 'Instalação solar',
      power: 'Projeto fotovoltaico',
      imageUrl: 'assets/projects/inversor-01.jpeg',
      alt: 'Inversor de energia solar instalado',
    },
    {
      title: 'Gerador Carla',
      category: 'Frame de vídeo',
      power: 'Registro de instalação',
      imageUrl: 'assets/projects/gerador-carla-frame.png',
      alt: 'Frame do vídeo do gerador Carla',
    },
    {
      title: 'Sistema Natalia',
      category: 'Frame de vídeo',
      power: 'Registro de instalação',
      imageUrl: 'assets/projects/filmagem-natalia-sistema-frame.png',
      alt: 'Frame do vídeo do sistema Natalia',
    },
  ],
};
...
export class Home implements AfterViewInit, OnDestroy {
      ...
      next: (content) =>
        this.content.set({
          ...
          projects: this.uniqueProjects(
            this.isLegacyProjects(content.projects)
              ? FALLBACK.projects
  ...
  ngAfterViewInit() {
    if (
      ...
      !canAnimate(window.matchMedia('(prefers-reduced-motion: reduce)').matches)
    )
      return;
    ...
    Promise.all([import('gsap'), import('gsap/ScrollTrigger')]).then(
      ([{ gsap }, { ScrollTrigger }]) => {
        ...
        this.motionContext = gsap.context(() => {
          ...
          intro
            .from('.hero-copy > *', { y: 26, opacity: 0, duration: 0.65, stagger: 0.07 })
            .from(
              '.hero-visual',
              { clipPath: 'inset(0 0 0 12%)', opacity: 0, duration: 0.9 },
              '<0.1',
            )
  ...
  openProject(index: number) {
    if (!this.suppressProjectClick) this.selectedProject.set(index);
  }
  closeProject() {
  ...
  submitContact(form: NgForm) {
    ...
    this.leads.create(payload).subscribe({
      next: () =>
        this.formMessage.set(`Obrigado, ${this.contact.name}. Em breve entraremos em contato.`),
      error: () =>
        this.formMessage.set('Não foi possível enviar agora. Fale conosco pelo WhatsApp.'),
    });
  }
}
